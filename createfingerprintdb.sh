...
echo "CREATE TABLE fingerprints (hashNumber bigint NOT NULL AUTO_INCREMENT, objectIdentifierValue varchar(1000) NOT NULL,startframe varchar(100),endframe varchar(100),hash1 varchar(27),hash2 varchar(27),hash3 varchar(27),hash4 varchar(27),hash5 varchar(27),hash6 varchar(27),hash7 varchar(27),hash8 varchar(27),hash9 varchar(27), PRIMARY KEY (hashNumber)
